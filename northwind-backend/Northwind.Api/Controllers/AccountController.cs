...
using Northwind.Application.Request;
...
namespace Northwind.Api.Controllers
{
    ...
    public class AccountController : ControllerBase
    {
        ...
        [HttpPost("register")]
        public async Task<ApiResponse<UserDto>> Register(UserDto user)
        {
            var apiResponse = new ApiResponse<UserDto>();

            try
            {
                var createdUser = await _accountService.Register(user, user.Password);
